...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/28 00:56:35 by blanna            #+#    #+#             */
/*   Updated: 2019/06/14 19:21:46 by blanna           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				**ft_strsplit_slash_n(char const *str, char c);
...
void				ft_int_arr_rev_void(int *arr, int len);
